...
//
// Substitui o antigo modelo de verbetes (`EbookItem`). O backend (migration 119)
// dropou `ebook_items` e criou `library_documents`. Tipos 1:1 com o web
// (`frontend/src/types/ebook.types.ts`).
