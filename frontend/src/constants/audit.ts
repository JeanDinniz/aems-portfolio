 ...
 *
 * Fonte única para AuditActionBadge, AuditToolbar e AuditTable — os valores
 * crus vêm do backend (app/core/audit.py e services que chamam log_audit).
 * Ação/entidade sem entrada aqui cai no fallback do componente.
 */
